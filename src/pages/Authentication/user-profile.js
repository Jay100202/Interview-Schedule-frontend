...
const UserProfile = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem("authUser")) {
      ...
      // Fetch project name and email from local storage
      const projectName = localStorage.getItem("firstName");
      const userEmail = localStorage.getItem("email");

      // Set state with the retrieved values
      setUserName(projectName || "Project Name");
      setemail(userEmail || "admin@gmail.com");
    }
  }, [dispatch, user]);
  ...
  document.title = "Profile | Clay World School";
  return (
    <React.Fragment>
